...
configure-moderation-perspective-allowSendFeedback =
  Permitir que o Coral envie ações de moderação para o Google
configure-moderation-perspective-allowSendFeedbackDescription =
  ...
  propósitos de criação de modelo comunitário para melhorar a API ao longo do tempo.
...
moderate-marker-newCommenter = Novo comentaristas
...
moderate-user-drawer-recent-history-tooltip-body =
  Comentários rejeitados ÷ (comentarios rejeitados + comentários publicados).
